...
public class ClassFirstMethodConstr extends ClassFirstMethod {

    private ConstructorDecl ConstructorDecl;

    public ClassFirstMethodConstr (ConstructorDecl ConstructorDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassFirstMethodConstr(\n");
